...
import com.example.set_a_goal.R;
...
import static com.example.set_a_goal.util.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.example.set_a_goal.util.CompactCalendarView.SMALL_INDICATOR;
import static com.example.set_a_goal.util.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.example.set_a_goal.util.CompactCalendarView.CompactCalendarViewListener;
...
class CompactCalendarController {
    ...
    CompactCalendarController(Paint dayPaint, OverScroller scroller, Rect textSizeRect, AttributeSet attrs, Context context,
